            ...
            <div class="col-lg-6">
              <div class="account__content account__content--style2">
                ...
                <div class="account__header">
                  <h2>Log in</h2>
                  <p class="mb-0">Hey there! Ready to log in? Just enter your credentials and we'll get you to your
                ...
                <!-- account divider -->
                <div class="account__divider account__divider--style2">
                ...
                <form action="#" class="account__form needs-validation" novalidate>
                  ...
                  <div class="account__check">
                    ...
                    <div class="account__check-forgot">
                      <a href="forgot-pass-2.html">Forgot Password?</a>
                    </div>
                  </div>
