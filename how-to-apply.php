...
<body>
    ...
    <section class="page-header bg--cover" style="background-image:url(assets/images/header/banner3.png)">
        <div class="container">
    ...
    <section class="pricing padding-top padding-bottom">
        <div class="section-header section-header--max50">
            <h2 class="mb-10 mt-minus-5">How to <span>Apply </span></h2>
            <p>Take the leap towards a brighter future. Follow these steps to apply and become a part of our inspiring
                            ...
                            <div class="pricing__item-inner">
                                <div class="pricing__item-content">
                                    ...
                                    <div class="pricing__item-top">
                                        <h6 class="mb-15">Where To Apply</h6>
                                    </div>
                                    ...
                                    <div class="pricing__item-middle">
                                        <ul class="pricing__list">
                                            <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg"
                                                ...
                                                Visit www.sahajanandcollege.org.in/admissions > Go to Admission.</li>
                                        </ul>
                                    ...
                                    <div class="pricing__item-bottom">
                                        <a href="admissions.php" class="trk-btn trk-btn--outline">Apply Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pricing__item " data-aos="fade-up" data-aos-duration="1000">
                            <div class="pricing__item-inner active">
                                <div class="pricing__item-content">
                                    ...
                                    <!-- pricing top part -->
                                    <div class="pricing__item-top">
                                        <h6 class="mb-15">Application & Documents</h6>
                                    </div>
                                    ...
                                    <div class="pricing__item-middle">
                                        <ul class="pricing__list">
                                            <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg"
                                                        alt="check" class="dark"></span>
                                                Fill up the admission form & attach the relevant documents.</li>
                        ...
                        <div class="pricing__item" data-aos="fade-left" data-aos-duration="1000">
                            <div class="pricing__item-inner">
                                <div class="pricing__item-content">
                                    ...
                                    <!-- pricing top part -->
                                    <div class="pricing__item-top">
                                        <h6 class="mb-15">Verification</h6>
                                    </div>
                                    ...
                                    <div class="pricing__item-middle">
                                        <ul class="pricing__list">
                                            <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg"
                                                        alt="check" class="dark"></span>
                                                We will verify the documents.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
