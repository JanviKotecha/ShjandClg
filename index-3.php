 ...
 <?php include("include/preloder.php"); ?>
          ...
          <div class="col-lg-5 col-md-5">
            <div class="banner__content" data-aos="fade-right" data-aos-duration="1000">
              ...
              <p class="banner__content-moto">Anyone can invest money to different currency to increase their earnings
                by the help of tradingo through online.
              </p>
              <div class="banner__btn-group btn-group">
                <a href="signin.html" class="trk-btn trk-btn--primary">Get Started</a>
                ...
                <a href="https://www.youtube.com/watch?v=MHhIzIgFgJo&ab_channel=NoCopyrightFootages" class="trk-btn trk-btn--defult" data-fslightbox>
                  <span class="style1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    </svg></span> <span class="d-md-none d-lg-block">Watch Video</span>
                </a>
              </div>
            </div>
          </div>
            ...
            <div class="banner__counter">
              <div class="banner__counter-inner">
                <div class="banner__counter-item">
                  <h4> <span class="purecounter" data-purecounter-start="0" data-purecounter-end="10">10</span> Years
                  </h4>
                ...
                <div class="banner__counter-item">
                  <h4> <span class="purecounter" data-purecounter-start="0" data-purecounter-end="25">25</span>K+
                  </h4>
  ...
  <section class="feature feature--style2 padding-bottom padding-top feature-bg-color bg--cover"
    ...
    <div class="section-header section-header--style3 section-header--max57">
      <h2 class="mb-10 mt-minus-5">Features We have</h2>
      <p>Hey there! Here are the features we have: user-friendly interface, top-notch security, and fast performance.
      </p>
    </div>
    <div class="container">
        ...
        <div class="row g-5">
          ...
          <div class="col-md-6">
            <div class="about__content" data-aos="fade-left" data-aos-duration="800">
              ...
              <p class="mb-0">Hey folks! Meet our platform! With our platform, you'll get access to all the info you
        ...
        <div class="row g-5 mt-100">
          <div class="col-md-6">
            <div class="about__content" data-aos="fade-right" data-aos-duration="800">
              ...
              <a href="team.html" class="trk-btn trk-btn--border trk-btn--primary">Meet our experts</a>
            </div>
          </div>
          <div class="col-md-6">
