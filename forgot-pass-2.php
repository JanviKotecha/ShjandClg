...
<body>
 ...
 <?php include("include/preloder.php"); ?>
  ...
  <header class="header-section bg-color-3 d-none">
            ...
            <div class="col-lg-6">
              <div class="account__content account__content--style2">
                ...
                <div class="account__header">
                  ...
                  <p class="mb-0">Hey there! Forgot your password? No worries! Just click on "Reset password" and follow
                ...
                <div class="account__switch">
                  <p><a href="signin-2.html" class="style2"><i class="fa-solid fa-arrow-left-long"></i> Back to <span>Login</span></a></p>
                </div>
              </div>
            </div>
          </div>
