  ...
  <section class="banner banner--style4 bg--cover" style="background-image:url(assets/images/banner/home4/1.png)">
        ...
        <div class="row justify-content-center">
          <div class="col-md-10 justify-content-center">
            <div class="banner__content" data-aos="fade-up" data-aos-duration="800">
              ...
              <p>Explore our comprehensive resources and expert insights to empower your trading journey. Master the art
                of making decision.
              </p>
              <div class="banner__content-btn btn-group justify-content-center">
                <a href="signin.html" class="trk-btn trk-btn--primary trk-btn--arrow">trading now </a>

                <a href="https://www.youtube.com/watch?v=MHhIzIgFgJo&ab_channel=NoCopyrightFootages" class="playbtn"
                  data-fslightbox>
    ...
    <div class="banner__shape">
      <span class="banner__shape-item banner__shape-item--1"><img src="assets/images/banner/home1/4.png"
          alt="shape icon"></span>
      <span class="banner__shape-item banner__shape-item--5"><img src="assets/images/banner/home4/2.png"
          alt="shape icon"></span>
    </div>
          ...
          <div class="row g-3">
            <div class="col-sm-6 col-lg-3">
              <div class="counter__item" data-aos="fade-up" data-aos-duration="800">
                <div class="counter__item-inner">
                  <img src="assets/images/banner/home4/icon/1.png" alt="icon" class="dark">
                  <h3><span class="purecounter" data-purecounter-start="880" data-purecounter-end="900">900</span> M+
                  </h3>
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="counter__item" data-aos="fade-up" data-aos-duration="1000">
                <div class="counter__item-inner">
                  <img src="assets/images/banner/home4/icon/2.png" alt="icon" class="dark">
                  <h3><span class="purecounter" data-purecounter-start="0" data-purecounter-end="10">10</span>+ years
                  </h3>
                  <p>total market value</p>
                </div>
              </div>
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="counter__item" data-aos="fade-up" data-aos-duration="1000">
                <div class="counter__item-inner">
                  <img src="assets/images/banner/home4/icon/3.png" alt="icon" class="dark">
                  <h3><span class="purecounter" data-purecounter-start="70" data-purecounter-end="80">80</span>+</h3>
                  <p>total market value</p>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-3">
              <div class="counter__item" data-aos="fade-up" data-aos-duration="1200">
                <div class="counter__item-inner">
                  <img src="assets/images/banner/home4/icon/4.png" alt="icon" class="dark">
        ...
        <div class="row g-4 align-items-center">
          ...
          <div class="col-md-6">
            <div class="about__content" data-aos="fade-left" data-aos-duration="800">
              ...
              <p class="mb-0">Hey there! So glad you stopped by to Meet Our Company. Don't miss out on this opportunity
                to learn about what we do and the amazing team that makes it all happen! Our company is all about
                creating innovative solutions and providing top-notch services to our clients. From start to finish,
                we're dedicated to delivering results that exceed expectations. </p>
