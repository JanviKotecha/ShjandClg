        ...
        <div class="container">
            <div class="section-header d-md-flex align-items-center justify-content-between">
                <div class="section-header__content">
                    <h2 class="mb-10">our College <span> Topers </span></h2>
                    <p class="mb-0">These outstanding achievers have set a new standard of excellence, making our college proud.
                    </p>
                </div>
            ...
            <div class="testimonial__wrapper" data-aos="fade-up" data-aos-duration="1000">
                <div class="testimonial__slider swiper">
                    <div class="swiper-wrapper">
                    <?php
                    $result = $qm->getRecord("topers","*","active=1");
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                         ?>
                        <div class="swiper-slide">
                                        ...
                                        <div class="testimonial__footer">
                                            <div class="testimonial__author">
                                                ...
                                                <div class="testimonial__author-designation">
                                                    ...
                                                    <br>
                                                    <span><?php echo $row['semester'], " - ", $row['year']; ?></span>
                                                    <br>
