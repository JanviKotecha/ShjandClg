...
<body class="home-5">
 ...
 <?php include("include/preloder.php"); ?>
  ...
  <div class="lightdark-switch ">
    <span class="switch-btn switch-btn--style2" id="btnSwitch"><img src="assets/images/icon/moon.svg" alt="light-dark-switchbtn"
    ...
    <div class="header-bottom">
      <div class="container">
        <div class="header-wrapper header-wrapper--style2">
          <div class="logo">
            <a href="index.html">
              <img src="assets/images/logo/logo-2.png" alt="logo" class="dark">
            </a>
          </div>
                        ...
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-2.html?theme=light"
                                  class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                        ...
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-3.html?theme=light"
                                  class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                        ...
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-3.html?theme=dark"
                                  class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                        ...
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-4.html?theme=light"
                                  class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                        ...
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-4.html?theme=dark"
                                  class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                        ...
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-5.html?theme=light"
                                  class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
                        ...
                        <div class="col">
                          <div class="home-showcase__item">
                            <div class="home-showcase__image">
                              ...
                              <div class="home-showcase__buttons">
                                <a href="index-5.html?theme=dark"
                                  class="trk-btn trk-btn--primary home-showcase__buttons-item mt-3"><span>Preview</span></a>
                              </div>
                            </div>
            ...
            <div class="header-action">
              <div class="menu-area">
                <div class="header-btn">
                  <a href="signup.html" class="trk-btn trk-btn--tertiary">
                    <span>Register</span>
                  </a>
                </div>
  ...
  <section class="banner banner--style5">
                        ...
                        <div class="testimonial__item-inner">
                          <div class="testimonial__item-body">
                            <div class="testimonial__item-content">
                              <p class="mb-0">
                                “It's the art of interpreting possibilities and embracing opportunities that shape your
                                financial journey.”
                              </p>
                            </div>
                          ...
                          <div class="testimonial__item-footer">
                            <div class="testimonial__author">
                              ...
                              <div class="testimonial__author-designation testimonial__author-designation--style2">
                                <p>Mobarok Hossain</p>
                      ...
                      <div class="testimonial__item testimonial__item--style3">
                        <div class="testimonial__item-inner">
                          <div class="testimonial__item-body">
                            <div class="testimonial__item-content">
                              <p class="mb-0">
                                “Crafting your financial path revolves around the skill of deciphering possibilities and
                      ...
                      <div class="testimonial__item testimonial__item--style3">
                        <div class="testimonial__item-inner">
                          <div class="testimonial__item-body">
                            <div class="testimonial__item-content">
                              <p class="mb-0">
                                “Interpreting possibilities and seizing opportunities are the cornerstone of shaping
              ...
              <div class="col-12">
                <div class="banner__thumb">
                  <div class="banner__thumb-inner">
                    <img src="assets/images/banner/home5/1.png" alt="banner-thumb">
                  </div>
                </div>
              </div>
              <div class="col-12">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="banner__thumb2">
              <div class="banner__thumb2-inner">
                <img src="assets/images/banner/home5/2.png" alt="banner thumb">
    ...
    <div class="banner__shape">
      <span class="banner__shape-item banner__shape-item--6"><img src="assets/images/banner/shape/4.png"
          alt="shape icon"></span>
      <span class="banner__shape-item banner__shape-item--7"><img src="assets/images/banner/shape/3.png"
          alt="shape icon"></span>
    </div>
            ...
            <div class="swiper-slide">
              <div class="partner__item">
                <div class="partner__item-inner">
                  <img src="assets/images/partner/home5/1.png" alt="partner logo">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner__item">
                <div class="partner__item-inner">
                  <img src="assets/images/partner/home5/2.png" alt="partner logo">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner__item">
                <div class="partner__item-inner">
                  <img src="assets/images/partner/home5/6.png" alt="partner logo">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner__item">
                <div class="partner__item-inner">
                  <img src="assets/images/partner/home5/4.png" alt="partner logo">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner__item">
                <div class="partner__item-inner">
                  <img src="assets/images/partner/home5/5.png" alt="partner logo">
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="partner__item">
                <div class="partner__item-inner">
                  <img src="assets/images/partner/home5/3.png" alt="partner logo">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row g-5 align-items-center justify-content-between">
            ...
            <div class="about__thumb about__thumb--style3" data-aos="fade-right" data-aos-duration="800">
              <div class="about__thumb-inner">
                <div class="about__thumb-image text-center floating-content">
                  <img src="assets/images/about/home5/2.png" alt="about-image">
                  <div class="floating-content__top-right floating-content__top-right--style3" data-aos="fade-up" data-aos-duration="1000">
                    <div class="floating-content__item floating-content__item--style6">
                      ...
                      <div class="progress">
                        <div class="progress-bar--style2 w-75" role="progressbar" aria-valuenow="90" aria-valuemin="0"
          ...
          <div class="col-md-6">
            <div class="about__content" data-aos="fade-left" data-aos-duration="800">
              ...
              <ul>
                <li><span><img src="assets/images/about/home5/check.png" alt="check" class="dark"></span> Building a Better Trading
                  Future</li>
                <li><span><img src="assets/images/about/home5/check.png" alt="check" class="dark"></span> Provide a Trading
                  Experience</li>
                <li><span><img src="assets/images/about/home5/check.png" alt="check" class="dark"></span> The Experts Behind Your
                  Success</li>
                <li><span><img src="assets/images/about/home5/check.png" alt="check" class="dark"></span> Empowering Traders
                  Worldwide</li>
              </ul>
        ...
        <div class="row g-4 align-items-center">
            ...
            <div class="service__item service__item--style3" data-aos="fade-up" data-aos-duration="800">
              <div class="service__item-inner text-center">
                <div class="service__item-thumb  mb-30">
                  <img src="assets/images/service/home5/1.png" alt="service-icon">
                </div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="service__item service__item--style3" data-aos="fade-up" data-aos-duration="1000">
              <div class="service__item-inner text-center">
                <div class="service__item-thumb mb-30">
                  <img src="assets/images/service/home5/2.png" alt="service-icon">
                </div>
                <div class="service__item-content">
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="service__item service__item--style3" data-aos="fade-up" data-aos-duration="1200">
              <div class="service__item-inner text-center">
                <div class="service__item-thumb mb-30">
                  <img src="assets/images/service/home5/3.png" alt="service-icon">
                </div>
                <div class="service__item-content">
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="service__item service__item--style3" data-aos="fade-up" data-aos-duration="800">
              <div class="service__item-inner text-center">
                <div class="service__item-thumb mb-30">
                  <img src="assets/images/service/home5/4.png" alt="service-icon">
                </div>
                <div class="service__item-content">
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="service__item service__item--style3" data-aos="fade-up" data-aos-duration="1000">
              <div class="service__item-inner text-center">
                <div class="service__item-thumb mb-30">
                  <img src="assets/images/service/home5/5.png" alt="service-icon">
                </div>
                <div class="service__item-content">
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="service__item service__item--style3" data-aos="fade-up" data-aos-duration="1200">
              <div class="service__item-inner text-center">
                <div class="service__item-thumb mb-30">
                  <img src="assets/images/service/home5/6.png" alt="service-icon">
                </div>
                <div class="service__item-content">
                ...
                <div class="pricing__item-content">
                  ...
                  <div class="pricing__item-middle">
                    <ul class="pricing__list">
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check1.svg" alt="check" class="dark"></span>
                        Weekly online meeting</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check1.svg" alt="check" class="dark"></span>
                        Unlimited learning access</li>
                      <li class="pricing__list-item pricing__list-item--mute"><span><img src="assets/images/icon/check1.svg" alt="check" class="dark"></span>
            ...
            <div class="pricing__item pricing__item--style2" data-aos="fade-up" data-aos-duration="1000">
              <div class="pricing__item-inner active">
                <div class="pricing__item-content">
                  ...
                  <div class="pricing__item-middle">
                    <ul class="pricing__list">
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check1.svg" alt="check"></span>
                        Weekly online meeting</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check1.svg" alt="check"></span>
                        Unlimited learning access</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check1.svg" alt="check"></span>
  ...
  <section class="faq padding-top padding-bottom of-hidden">
    ...
    <div class="container">
      <div class="faq__wrapper"> 
        <div class="row g-5 align-items-center justify-content-between">
          <div class="col-lg-6">
            <div class="accordion accordion--style3" id="faqAccordion1" data-aos="fade-right" data-aos-duration="1000">
              <div class="row">
                <div class="col-12">
                  <div class="accordion__item accordion-item">
                    <div class="accordion__header accordion-header" id="faq1">
                      <button class="accordion__button accordion-button accordion-button--style2" type="button" data-bs-toggle="collapse"
                ...
                <div class="col-12">
                  <div class="accordion__item accordion-item">
                    <div class="accordion__header accordion-header" id="faq2">
                      <button class="accordion-button accordion-button--style2 accordion__button collapsed" type="button"
          ...
          <div class="col-lg-6">
            <div class="faq__thumb  text-center" data-aos="fade-left" data-aos-duration="1000">
              <img src="assets/images/others/4.png" alt="faq-thumb">
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="blog padding-top padding-bottom bg-color">
    <div class="blog__bg">
      <div class="blog__bg-element">
        <img src="assets/images/blog/bg.png" alt="section-bg-element" class="dark">
      </div>
    </div>
    <div class="container">
      <div class="section-header d-md-flex align-items-center justify-content-between">
    ...
    <div class="container">
      <div class="cta__wrapper">
        <div class="cta__newsletter justify-content-center">
          <div class="cta__newsletter-inner cta__newsletter-inner--style3" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="cta__subscribe">
              ...
              <form class="cta-form cta-form--style2 form-subscribe" action="#">
                <div class="cta-form__inner d-sm-flex align-items-center">
                  ...
                  <button class="trk-btn  trk-btn--large trk-btn--secondary3" type="submit">Submit</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="row gy-5 gx-4">
            <div class="col-md-6">
              <div class="footer__about">
                <a href="index.html" class="footer__about-logo"><img src="assets/images/logo/Logo-2-dark.png"
                    alt="Logo"></a>
              ...
              <div class="footer__links">
                ...
                <div class="footer__links-content">
                  <ul class="footer__linklist">
                    <li class="footer__linklist-item"> <a class="style2" href="about.html">About Us</a>
                    </li>
                    <li class="footer__linklist-item"> <a class="style2" href="team.html">Teams</a>
                    </li>
                    <li class="footer__linklist-item"> <a class="style2" href="service.html">Services</a> </li>
            ...
            <div class="col-md-2 col-sm-4 col-6">
              <div class="footer__links">
                ...
                <div class="footer__links-content">
                  <ul class="footer__linklist">
                    <li class="footer__linklist-item"> <a class="style2" href="#">Terms & Conditions</a>
                    </li>
                    <li class="footer__linklist-item"> <a class="style2" href="#">Privacy Policy</a>
                    </li>
                    <li class="footer__linklist-item"> <a class="style2" href="#">FAQs</a></li>
                    <li class="footer__linklist-item"> <a class="style2" href="#">Support Center</a> </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="footer__links">
                ...
                <div class="footer__links-content">
                  <ul class="footer__linklist">
                    ...
                    <li class="footer__linklist-item"> <a class="style2" href="#">Job</a> </li>
          ...
          <div class="footer__end">
            <div class="footer__end-copyright">
              <p class=" mb-0">© 2024 All Rights Reserved By <a href="https://themeforest.net/user/thetork/portfolio"
                  target="_blank" class="style2">Thetork</a> </p>
            </div>
            <div>
              <ul class="social">
                <li class="social__item">
                  <a href="#" class="social__link social__link--style222"><i class="fab fa-facebook-f"></i></a>
                </li>
                <li class="social__item">
                  <a href="#" class="social__link social__link--style222 "><i class="fab fa-instagram"></i></a>
                </li>
                <li class="social__item">
                  <a href="#" class="social__link social__link--style222"><i class="fa-brands fa-linkedin-in"></i></a>
                </li>
                <li class="social__item">
                  <a href="#" class="social__link social__link--style222"><i class="fab fa-youtube"></i></a>
                </li>
                <li class="social__item">
                  <a href="#" class="social__link social__link--style222 "><i class="fab fa-twitter"></i></a>
                </li>
              </ul>
            </div>
          </div>
