                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Course Detail
                                        <a href="course_add.php" class="btn btn-primary" style="float: right;"><i
                          ...
                          if (mysqli_num_rows($result)>0) {
                            ...
                            while ($row=mysqli_fetch_array($result)) { 
                              $i++;?>
                                                <tr>
                                                    <td>&nbsp;&nbsp;&nbsp;<?php echo $i; ?></td>
                                                    <td><img src="<?php echo $row["c_img"]=='' ? COURSE_URL.'noimg.png' : (file_exists(UPLOAD_COURSE_URL.$row["c_img"]) ? COURSE_URL.$row["c_img"] : COURSE_URL.'noimg.png'); ?>"
                                                            class="border c-img">
                                                    </td>

                                                    <td><?php echo $row['c_name'] . "<br>" . $row['c_subtitle']; ?></td>
                                                    <td><?php echo $row['duration']; ?></td>
                                                    <td><?php echo $row['medium']; ?></td>
                                                    <td><?php echo $row['eligibility']; ?></td>
                                                    <td><?php echo $row['objective']; ?></td>
                                                    <td><?php echo $row['after_graduation']; ?></td>
                                                    <td><?php echo $row['created_at']; ?></td>
                                                    <td><?php echo $row['updated_at']; ?></td>
                                                    <td>
                                                        <a class="btn btn-primary width"
                                                            href="course_update.php?id=<?php echo $row['id'];?>"><i
