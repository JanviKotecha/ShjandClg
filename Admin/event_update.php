...
if (isset($_POST['add'])) {
  ...
  $qm->updateRecord("events","title='".$title."',link='".$link."',updated_at='".$getDt."'","id=".$id);
  ...
  if(isset($_FILES['image']['tmp_name']) && !empty($_FILES['image']['tmp_name'])){
    ...
    if(in_array($ext,$allowd)) {
      ...
      $_SESSION['alert_msg'] .= "<div class='msg_success'>Eventes updated successfully.</div>";
              ...
              <div class="card">
                <div class="card-body">
                  <form class="form-sample" action="" method="Post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-3">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="link" value="<?php echo $row['link'] ?>" pattern="https?://.+" required />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 mb-3">
                          <div class="form-group row">
                            <div class="col-sm-12">
                              <center><img src="<?php echo $row["img"]=='' ? EVENTS_URL.'noimg.png' : (file_exists(UPLOAD_EVENTS_URL.$row["img"]) ? EVENTS_URL.$row["img"] : EVENTS_URL.'noimg.png'); ?>" style="width : 40%;" /></center>
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <center><br /><button type="submit" name="add" class="btn btn-primary">Update</button>
